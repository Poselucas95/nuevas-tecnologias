...
namespace GymSolutions.Controllers
{
    public class AspNetUsersController : Controller
    {
        ...
        {
            var aspNetUsers = db.AspNetUsers.Include(a => a.Perfil);
        ...
        {
            ViewBag.Id = new SelectList(db.Perfil, "ID_PERFIL", "perfilNombre");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName")] AspNetUsers aspNetUsers)
        {
            if (ModelState.IsValid)
            {
                ...
                Perfil perfil = new Perfil(aspNetUsers.Id);
                db.Perfil.Add(perfil);
                db.SaveChanges();
                return RedirectToAction("Index");
            }

            ViewBag.Id = new SelectList(db.Perfil, "ID_PERFIL", "perfilNombre", aspNetUsers.Id);
            return View(aspNetUsers);
        }
